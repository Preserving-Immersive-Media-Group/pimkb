...
{% hint style="warning" %}
Unreal Engine 4 has now been superseded by Unreal Engine 5 and will no longer receive updates. It it possible to migrate projects from version 4 to 5 but manual migration of some elements may be required. See Epic's [migration guide](https://docs.unrealengine.com/5.0/en-US/unreal-engine-5-migration-guide/) for more information.
{% endhint %}
