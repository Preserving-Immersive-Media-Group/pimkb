...
* Archive a copy of the **360-degree video file** in a suitable [preservation format](video-formats.md).
...
* **Identify and test** suitable 360-degree **video player software**, via [XR hardware](../preserving-xr-hardware/head-mounted-display/).
